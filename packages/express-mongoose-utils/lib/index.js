...
class DbController {
    constructor(service, entityName) {
        ...
        this.getList = (self = this) => (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const filter = filterArray.length ? filterArray.reduce((p, n) => (Object.assign(Object.assign({}, p), n))) : {};
        ...
        this.checkExists = (self = this) => (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const isExist = yield self._service.exists({ _id: req.params[self._metaData[0]] });
                if (isExist) {
                    return next();
                }
                res.status(404);
...
class DbControllerWithPermission extends DbController {
    constructor() {
        ...
        this.getDetail = (self = this) => (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            return res.send((0, exports.successResponse)({ data: { [self._metaData[1]]: Object.assign(Object.assign({}, detail), { permissions: permissions === null || permissions === void 0 ? void 0 : permissions.permissions }) } }));
        });
        this.getList = (self = this) => (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { userid: userId } = req.headers;
            const { pageNumber, pageSize, sortOrder, sortBy } = req.query;
        ...
        this.deleteOne = (self = this) => (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield permission_service_1.default.deleteMany({ entityId: req.params[self._metaData[0]] });
            yield self._service.deleteOne({ _id: req.params[self._metaData[0]] });
            return res.send({ message: 'Deleted Successfully' });
        });
